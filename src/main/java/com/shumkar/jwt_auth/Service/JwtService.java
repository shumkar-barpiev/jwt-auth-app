...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails){
        return buildToke(extraClaims, userDetails, jwtExpiration);
    }

    public long getExpirationTime(UserDetails userDetails){
    ...
    private String buildToke(Map<String, Object> extraClaims, UserDetails userDetails, long expiration) {
